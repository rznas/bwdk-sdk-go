...
// APIClient manages communication with the BWDK API API v1.0.0
...
type APIClient struct {
	...
	MerchantOrdersAPI *MerchantOrdersAPIService

	MerchantWalletAPI *MerchantWalletAPIService

	OrderShippingAPI *OrderShippingAPIService

	SellerProfileManagementAPI *SellerProfileManagementAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.MerchantOrdersAPI = (*MerchantOrdersAPIService)(&c.common)
	c.MerchantWalletAPI = (*MerchantWalletAPIService)(&c.common)
	c.OrderShippingAPI = (*OrderShippingAPIService)(&c.common)
	c.SellerProfileManagementAPI = (*SellerProfileManagementAPIService)(&c.common)
