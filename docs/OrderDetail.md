...
**MainAmount** | **int32** | مجموع قیمت‌های اولیه تمام کالاها بدون تخفیف (به تومان) | [readonly] 
...
**DiscountAmount** | **int32** | کل تخفیف اعمال شده بر سفارش (به تومان) | [readonly] 
...
**PreparationTime** | **int32** | زمان آمادهسازی سفارش (به روز) | [readonly] 
**Weight** | **float64** | وزن کل سفارش (بر حسب گرم) | [readonly] 
...
**DigipayMarkupAmount** | **int32** | مبلغ نشانه‌گذاری برای سفارش (به تومان) | [readonly] 
**MarkupCommissionPercentage** | **int32** | درصد کمیسیون نشانه‌گذاری برای سفارش (به درصد) | [readonly] 
